...
- 2025 waiver backtest (`scripts/backtest/`, `docs/BACKTEST.md`). The stash default ranks by 3-week projection minus that of the starter each pick would replace (variant V7), at most 5; ranking by raw 3-week projection had favored backup QBs.
